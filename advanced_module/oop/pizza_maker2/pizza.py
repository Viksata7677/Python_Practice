from pizza_maker2.dough import Dough
from pizza_maker2.topping import Topping
...
class Pizza:
    ...
    def calculate_total_weight(self):
        pizza_weight = self.dough.weight + sum(t_weight for t_weight in self.toppings.values())
        return pizza_weight
